...
ActiveRecord::Schema.define(version: 2021_02_15_004413) do
  ...
  create_table "gones", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "address"
    t.text "url"
    t.string "tel"
  ...
  create_table "posteds", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "address"
    t.text "url"
    t.datetime "created_at", null: false
  ...
  create_table "rests", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "address"
    t.text "url"
    t.datetime "created_at", null: false
  ...
  create_table "wants", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "address"
    t.text "url"
    t.string "caption"
